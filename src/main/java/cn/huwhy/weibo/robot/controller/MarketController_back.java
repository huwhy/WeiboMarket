...
//
//public class MarketController_back extends BaseController implements Initializable {
//
...
//            if (driver == null) {
//                driver = MarketController_back.this.chromeBrowserService.getDriver(account);
